...
export const showChannelCreateModal = createAction('CHANNEL_CREATE_MODAL');
export const showChannelRemoveModal = createAction('CHANNEL_REMOVE_MODAL');
export const showChannelRenameModal = createAction('CHANNEL_RENAME_MODAL');
